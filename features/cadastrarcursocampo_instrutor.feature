...
Esquema do Cenario: Cadastro de Curso com informações distintas no campo instrutor
...
Exemplos:
    ...
    |Curso de Python||Curso de Python     ||          ||https://drive.google.com/file/d/1B1-uzIV15H6vRSlq0O4HrN15buoC8EK4/view?usp=drive_link  || 01-04-2026     || 01-05-2026  || 5               || Presencial    || Informe um instrutor!                           |
    |Curso de Python||Curso de Python     ||   123456 ||https://drive.google.com/file/d/1B1-uzIV15H6vRSlq0O4HrN15buoC8EK4/view?usp=drive_link  || 01-04-2026     || 01-05-2026  || 5               || Presencial    || O instrutor do curso deve conter apenas letras! |
    |Curso de Python||Curso de Python     ||   #@$%   ||https://drive.google.com/file/d/1B1-uzIV15H6vRSlq0O4HrN15buoC8EK4/view?usp=drive_link  || 01-04-2026     || 01-05-2026  || 5               || Presencial    || O instrutor do curso deve conter apenas letras! |
