...
Esquema do Cenario: Cadastro de Curso com informações distintas na descrição do curso
    ...
    E informa o tipo de curso que pode ser online "<Tipo de curso>"
    E o site abre um novo campo para o tipo online onde o usuario deve informar o link do curso "<Link do curso>"
...
Exemplos:
    | nome do curso || descrição do curso || instrutor|| URL da imagem de capa                                                                || Data de ínicio || Data de fim || Número de vagas || Tipo de curso || link de inscrição                                                                      ||Mensagem                       |
